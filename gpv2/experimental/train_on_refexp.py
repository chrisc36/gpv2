...
from gpv2.train.evaluator import VqaEvaluator, ResultKey, RefExpEvaluator
...
def main():
  ...
  model = T5GpvPerBox(
    ...
    preprocessors=[ReferringExpressionQueryPreprocessor()]
  )
  ...
  trainer: Trainer = Trainer(
    ...
    epochs=args.epochs,
    best_model_key=ResultKey("acc", dataset_name="val"),
